...
export function AuroraBackground() {
  return (
    <div className="pointer-events-none absolute inset-0 overflow-hidden">
      {/* Primary blob */}
      <motion.div
        className="absolute -top-[40%] left-[20%] h-[80vh] w-[60vw] rounded-full opacity-[0.07]"
        style={{
          background:
      ...
      {/* Secondary blob */}
      <motion.div
        className="absolute -right-[10%] top-[10%] h-[60vh] w-[50vw] rounded-full opacity-[0.05]"
        style={{
          background:
      ...
      <motion.div
        className="absolute bottom-[10%] left-[40%] h-[40vh] w-[40vw] rounded-full opacity-[0.04]"
        style={{
          background:
